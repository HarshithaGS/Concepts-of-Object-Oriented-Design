...
public class Plant implements Comparable<Plant> {
	...
	//this is method to pass parameters from stem to Plant to grow the plants
	...
	public int no_of_childern() {
		if(this.check_for_BaseStem()) {
			...
			for(Stem child:MasterChildStem) {
				countt++;
	...
	public ArrayList<Stem> getMasterChildStem() {
		return MasterChildStem;
	}

	public void setMasterChildStem(ArrayList<Stem> masterChildStem) {
		MasterChildStem = masterChildStem;
	}
	
	//compare function needed when collections package is used for sorting
	public int compareTo(Plant pt) {	
	Plant f = pt;
		return this.Specimen_id - f.Specimen_id;
	}
}
